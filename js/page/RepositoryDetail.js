...
export default class RepositoryDetail extends Component {
  constructor(props) {
    ...
    var url = this.props.projectModel.item.html_url
      ? this.props.projectModel.item.html_url
      : TRENDING_URL + this.props.projectModel.item.fullName;
    var title = this.props.projectModel.item.full_name
  ...
  componentWillUnmount() {
    ...
    if (this.props.parentComponent) {
      this.props.parentComponent.updateFavorite();
    }
  }

...
export default class Popover extends React.Component {
  ...
  render() {
    ...
    const contentMarginRight = this.props.contentMarginRight
      ? this.props.contentMarginRight
      : 0;
    const styleOperation = {
      top: popoverOrigin.y ? popoverOrigin.y : 0,
      left:
        popoverOrigin.x - contentMarginRight
          ? popoverOrigin.x - contentMarginRight
          : 0,
    };
    ...
    return (
      <TouchableWithoutFeedback onPress={this.props.onClose}>
        <View
          ...
          />
          <Animated.View
            style={[styles.popover, styleOperation, ...extendedStyles.popover]}>
            <Animated.View
              ref="content"
